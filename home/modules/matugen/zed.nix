      ...
      themes = [
        {
          ...
          style = {
            ...
            syntax = {
              boolean = { color = "{{colors.tertiary.dark.hex}}"; font_style = null; font_weight = null; };
              comment = { color = "{{colors.on_surface_variant.dark.hex}}"; font_style = "italic"; font_weight = null; };
              "comment.doc" = { color = "{{colors.on_surface_variant.dark.hex}}"; font_style = "italic"; font_weight = null; };
              constant = { color = "{{colors.tertiary.dark.hex}}"; font_style = null; font_weight = null; };
              constructor = { color = "{{colors.secondary.dark.hex}}"; font_style = null; font_weight = null; };
              emphasis = { color = "{{colors.primary.dark.hex}}"; font_style = "italic"; font_weight = null; };
              "emphasis.strong" = { color = "{{colors.primary.dark.hex}}"; font_style = null; font_weight = 700; };
              function = { color = "{{colors.primary.dark.hex}}"; font_style = null; font_weight = null; };
              keyword = { color = "{{colors.secondary.dark.hex}}"; font_style = null; font_weight = null; };
              number = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              operator = { color = "{{colors.on_surface_variant.dark.hex}}"; font_style = null; font_weight = null; };
              property = { color = "{{colors.on_surface.dark.hex}}"; font_style = null; font_weight = null; };
              punctuation = { color = "{{colors.on_surface_variant.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.bracket" = { color = "{{colors.secondary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.delimiter" = { color = "{{colors.on_surface_variant.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.list_marker" = { color = "{{colors.on_surface_variant.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.special" = { color = "{{colors.secondary.dark.hex}}"; font_style = null; font_weight = null; };
              string = { color = "{{colors.tertiary.dark.hex}}"; font_style = null; font_weight = null; };
              "string.escape" = { color = "{{colors.tertiary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              "string.regex" = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              "string.special" = { color = "{{colors.on_tertiary_container.dark.hex}}"; font_style = null; font_weight = null; };
              "string.special.symbol" = { color = "{{colors.tertiary.dark.hex}}"; font_style = null; font_weight = null; };
              tag = { color = "{{colors.secondary.dark.hex}}"; font_style = null; font_weight = null; };
              "text.literal" = { color = "{{colors.tertiary.dark.hex}}"; font_style = null; font_weight = null; };
              ...
              "variable.special" = { color = "{{colors.primary.dark.hex}}"; font_style = null; font_weight = null; };
            };
          };
        }
        {
          ...
          style = {
            ...
            syntax = {
              boolean = { color = "{{colors.tertiary.light.hex}}"; font_style = null; font_weight = null; };
              comment = { color = "{{colors.on_surface_variant.light.hex}}"; font_style = "italic"; font_weight = null; };
              "comment.doc" = { color = "{{colors.on_surface_variant.light.hex}}"; font_style = "italic"; font_weight = null; };
              constant = { color = "{{colors.tertiary.light.hex}}"; font_style = null; font_weight = null; };
              constructor = { color = "{{colors.secondary.light.hex}}"; font_style = null; font_weight = null; };
              emphasis = { color = "{{colors.primary.light.hex}}"; font_style = "italic"; font_weight = null; };
              "emphasis.strong" = { color = "{{colors.primary.light.hex}}"; font_style = null; font_weight = 700; };
              function = { color = "{{colors.primary.light.hex}}"; font_style = null; font_weight = null; };
              keyword = { color = "{{colors.secondary.light.hex}}"; font_style = null; font_weight = null; };
              number = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              operator = { color = "{{colors.on_surface_variant.light.hex}}"; font_style = null; font_weight = null; };
              property = { color = "{{colors.on_surface.light.hex}}"; font_style = null; font_weight = null; };
              punctuation = { color = "{{colors.on_surface_variant.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.bracket" = { color = "{{colors.secondary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.delimiter" = { color = "{{colors.on_surface_variant.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.list_marker" = { color = "{{colors.on_surface_variant.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.special" = { color = "{{colors.secondary.light.hex}}"; font_style = null; font_weight = null; };
              string = { color = "{{colors.tertiary.light.hex}}"; font_style = null; font_weight = null; };
              "string.escape" = { color = "{{colors.tertiary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              "string.regex" = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              "string.special" = { color = "{{colors.on_tertiary_container.light.hex}}"; font_style = null; font_weight = null; };
              "string.special.symbol" = { color = "{{colors.tertiary.light.hex}}"; font_style = null; font_weight = null; };
              tag = { color = "{{colors.secondary.light.hex}}"; font_style = null; font_weight = null; };
              "text.literal" = { color = "{{colors.tertiary.light.hex}}"; font_style = null; font_weight = null; };
              ...
              "variable.special" = { color = "{{colors.primary.light.hex}}"; font_style = null; font_weight = null; };
            };
          };
        }
      ];
