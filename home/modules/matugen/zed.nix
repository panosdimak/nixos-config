...
{
  configFile = {
    "matugen/templates/zed-colors.json".text = builtins.toJSON {
      ...
      themes = [
        {
          ...
          style = {
            ...
            "editor.background" = "{{colors.surface_container_high.dark.hex}}";
            "editor.gutter.background" = "{{colors.surface_container_high.dark.hex}}";
            "editor.subheader.background" = "{{colors.surface_container_high.dark.hex}}";
            ...
            "terminal.background" = "{{colors.surface_container.dark.hex}}";
            ...
            syntax = {
              attribute = { color = "{{colors.tertiary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              boolean = { color = "{{colors.primary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              comment = { color = "{{colors.outline.dark.hex}}"; font_style = null; font_weight = null; };
              "comment.doc" = { color = "{{colors.outline.dark.hex}}"; font_style = null; font_weight = null; };
              constant = { color = "{{colors.tertiary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              constructor = { color = "{{colors.error.dark.hex}}"; font_style = null; font_weight = null; };
              emphasis = { color = "{{colors.tertiary_fixed_dim.dark.hex}}"; font_style = "italic"; font_weight = null; };
              "emphasis.strong" = { color = "{{colors.error.dark.hex}}"; font_style = null; font_weight = 800; };
              function = { color = "{{colors.primary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              keyword = { color = "{{colors.error.dark.hex}}"; font_style = null; font_weight = null; };
              number = { color = "{{colors.secondary.dark.hex}}"; font_style = null; font_weight = null; };
              operator = { color = "{{colors.primary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              property = { color = "{{colors.primary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              punctuation = { color = "{{colors.on_surface.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.bracket" = { color = "{{colors.on_surface.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.delimiter" = { color = "{{colors.on_surface.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.list_marker" = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              "punctuation.special" = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              string = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              "string.escape" = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              "string.regex" = { color = "{{colors.tertiary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              "string.special" = { color = "{{colors.tertiary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              "string.special.symbol" = { color = "{{colors.tertiary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              tag = { color = "{{colors.primary.dark.hex}}"; font_style = null; font_weight = null; };
              "text.literal" = { color = "{{colors.primary_fixed_dim.dark.hex}}"; font_style = null; font_weight = null; };
              type = { color = "{{colors.primary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
              variable = { color = "{{colors.on_surface.dark.hex}}"; font_style = null; font_weight = null; };
              "variable.special" = { color = "{{colors.primary_fixed.dark.hex}}"; font_style = null; font_weight = null; };
            };
          };
        }
        {
          ...
          style = {
            ...
            "editor.background" = "{{colors.surface_container.light.hex}}";
            "editor.gutter.background" = "{{colors.surface_container.light.hex}}";
            "editor.subheader.background" = "{{colors.surface_container_high.light.hex}}";
            ...
            "terminal.background" = "{{colors.surface_container.light.hex}}";
            ...
            syntax = {
              attribute = { color = "{{colors.tertiary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              boolean = { color = "{{colors.primary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              comment = { color = "{{colors.outline.light.hex}}"; font_style = null; font_weight = null; };
              "comment.doc" = { color = "{{colors.outline.light.hex}}"; font_style = null; font_weight = null; };
              constant = { color = "{{colors.tertiary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              constructor = { color = "{{colors.error.light.hex}}"; font_style = null; font_weight = null; };
              emphasis = { color = "{{colors.tertiary_fixed_dim.light.hex}}"; font_style = "italic"; font_weight = null; };
              "emphasis.strong" = { color = "{{colors.error.light.hex}}"; font_style = null; font_weight = 800; };
              function = { color = "{{colors.primary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              keyword = { color = "{{colors.error.light.hex}}"; font_style = null; font_weight = null; };
              number = { color = "{{colors.secondary.light.hex}}"; font_style = null; font_weight = null; };
              operator = { color = "{{colors.primary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              property = { color = "{{colors.primary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              punctuation = { color = "{{colors.on_surface.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.bracket" = { color = "{{colors.on_surface.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.delimiter" = { color = "{{colors.on_surface.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.list_marker" = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              "punctuation.special" = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              string = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              "string.escape" = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              "string.regex" = { color = "{{colors.tertiary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              "string.special" = { color = "{{colors.tertiary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              "string.special.symbol" = { color = "{{colors.tertiary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              tag = { color = "{{colors.primary.light.hex}}"; font_style = null; font_weight = null; };
              "text.literal" = { color = "{{colors.primary_fixed_dim.light.hex}}"; font_style = null; font_weight = null; };
              type = { color = "{{colors.primary_fixed.light.hex}}"; font_style = null; font_weight = null; };
              variable = { color = "{{colors.on_surface.light.hex}}"; font_style = null; font_weight = null; };
              "variable.special" = { color = "{{colors.primary_fixed.light.hex}}"; font_style = null; font_weight = null; };
            };
          };
        }
      ];
  ...
  fallback = createIfMissing "${configHome}/zed/themes/matugen.json" ''
{"$schema":"https://zed.dev/schema/themes/v0.2.0.json","name":"Matugen","author":"Matugen","themes":[{"name":"Matugen Dark","appearance":"dark","style":{"background":"#${colors.surface}","border":"#${colors.outline}","editor.background":"#${colors.surface}","editor.foreground":"#${colors.on_surface}","editor.gutter.background":"#${colors.surface}","element.background":"#${colors.surface_container}","element.hover":"#${colors.surface_bright}","text":"#${colors.on_surface}","text.muted":"#${colors.on_surface_variant}","text.accent":"#${colors.primary}","icon":"#${colors.on_surface}","status_bar.background":"#${colors.surface}","title_bar.background":"#${colors.surface}","toolbar.background":"#${colors.surface}","tab_bar.background":"#${colors.surface_container}","tab.active_background":"#${colors.surface_bright}","panel.background":"#${colors.surface}","terminal.background":"#${colors.surface}","terminal.foreground":"#${colors.on_surface}","error":"#${colors.error}","hint":"#${colors.primary}","players":[{"cursor":"#${colors.primary}","background":"#${colors.primary}80","selection":"#${colors.primary}40"}],"syntax":{"comment":{"color":"#${colors.on_surface_variant}","font_style":"italic"},"function":{"color":"#${colors.primary}"},"keyword":{"color":"#${colors.secondary}"},"string":{"color":"#${colors.on_surface_variant}"},"variable":{"color":"#${colors.on_surface}"}}}}]}'';
}
