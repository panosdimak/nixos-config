{ colors, createIfMissing, configHome, ... }:
{
  ...
  fallback = createIfMissing "${configHome}/quickshell/overview/common/Appearance.colors.qml" ''
import QtQuick

QtObject {
    id: m3

    property color m3primary: "#${colors.primary}"
    property color m3onPrimary: "#${colors.on_primary}"

    property color m3primaryContainer: "#313244"
    property color m3onPrimaryContainer: "#b4befe"

    property color m3secondary: "#${colors.secondary}"
    property color m3onSecondary: "#${colors.on_primary}"

    property color m3secondaryContainer: "#${colors.surface_container_high}"
    property color m3onSecondaryContainer: "#${colors.secondary}"

    property color m3background: "#${colors.surface}"
    property color m3onBackground: "#${colors.on_surface}"

    property color m3surface: "#${colors.surface}"

    property color m3surfaceContainerLow: "#${colors.surface_container_low}"
    property color m3surfaceContainer: "#${colors.surface_container}"
    property color m3surfaceContainerHigh: "#${colors.surface_container_high}"
    property color m3surfaceContainerHighest: "#${colors.surface_container_highest}"

    property color m3onSurface: "#${colors.on_surface}"

    property color m3surfaceVariant: "#${colors.surface_variant}"
    property color m3onSurfaceVariant: "#${colors.on_surface_variant}"

    property color m3inverseSurface: "#${colors.on_surface}"
    property color m3inverseOnSurface: "#${colors.inverse_on_surface}"

    property color m3outline: "#${colors.outline}"
    property color m3outlineVariant: "#${colors.surface_variant}"
